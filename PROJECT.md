...
| **v26.9.1** | Аудит: canvas GC в fetchPhotoAsBase64 · try/catch в triggerPwaInstall, doExportSingle, toggleWakeLock · структура toggleWakeLock восстановлена · _applyWakeBtn вынесен из тела функции |
...
*Документ актуален для версии **v26.9.1***  
