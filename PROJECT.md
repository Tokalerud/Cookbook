...
| **v26.8.7** | Микрофон в покупках переписан: накапливает речь молча → при стопе вставляет в поле и авто-разбирает парсером |
...
*Документ актуален для версии **v26.8.7***  
