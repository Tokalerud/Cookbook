...
| **v26.8.5** | Shortcuts: +«Список покупок» (?action=shop) +«Меню на неделю» (?action=planner) · share_target: «Поделиться» из браузера → авто-импорт URL рецепта |
...
*Документ актуален для версии **v26.8.5***  
