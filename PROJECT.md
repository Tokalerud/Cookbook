...
| **v26.9.8** | Предрелизный аудит: doExportRecipes try/catch + null-check window.open · handlePhotoPaste: убран лишний async |
...
*Документ актуален для версии **v26.9.8***  
