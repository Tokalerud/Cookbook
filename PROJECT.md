...
| **v26.8.9** | Микрофон: корневое исправление — continuous:false + interimResults:false, берём results[last][0] — один чистый результат на паузу без дублей |
...
*Документ актуален для версии **v26.8.9***  
