...
| v26.9 | Голосовой ввод удалён полностью |
| v26.9.1 | Аудит: canvas GC · try/catch в async функциях · структура toggleWakeLock |
| v26.9.2 | Textarea ручного ввода: rows 6→3 |
| v26.9.3 | saveDatabase: убран showSaveFilePicker → downloadFile |
| v26.9.4 | Все выгрузки → Загрузки без диалога · Блок импорта компактнее |
| v26.9.5 | Текст подсказки в блоке Импорт по URL |
| v26.9.6 | О программе: предупреждение о хранении данных |
| v26.9.7 | Seed: шарлотка удалена · Борщ и Оливье с фото |
| v26.9.8 | Предрелизный аудит: doExportRecipes try/catch · handlePhotoPaste: убран async |
| v26.9.9 | Кнопка 💡 на фото рецепта слева снизу |
| v27.0 | Кнопка 💡 на фото + в action-bar |
| v27.0.1 | Убрал кнопки из режима без фото |
| v27.0.2 | Режим без фото: обе overlay-кнопки 🛒 и 💡 |
| **v27.0.3** | Режим без фото: 💡 слева снизу, 🛒 справа снизу — как на фото |
...
*Документ актуален для версии **v27.0.3***  
